...
\end{center}
\begin{enumerate}
\item Is (Ashley, Victoria) $\in$ Totman-Rel ? \wordchoice{\choice[correct]{Yes} \choice{No}}





\item Is (Ashley, sCrista) $\in$ Totman-Rel ? \wordchoice{\choice[correct]{Yes} \choice{No}}


\item Is (Ashley, Kevin) $\in$ Totman-Rel ?  \wordchoice{\choice[correct]{Yes} \choice{No}}
\item Is (Ashley, Alex) in the  Totman-Rel ?  \wordchoice{\choice[correct]{Yes} \choice{No}}
