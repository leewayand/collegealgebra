...
Is SameAge reflexive? Yes. A person is the same age as himself or herself. The pair (person1, person1) is \textbf{ALWAYS} in SameAge.

Is SameAge symmetric? Yes. If (person1, person2) $\in$ SameAge, then person1 and person2 are the same age, which means that  (person1, person2) $\in$ SameAge - \textbf{ALWAYS}.

Is SameAge transitive? Yes. (person1, person2) $\in$ SameAge and (person2, person3) $\in$ SameAge, than (person1, person3) $\in$ SameAge. \textbf{ALWAYS}.   
...
Is Older reflexive? No. A person is not older than himself or herself. The pair (person1, person1) cannot be in Older.

Is Older symmetric? No. (Sally, Dawn) $\in$ Older, but (Dawn, Sally) is not since Sally is not older than Dawn.

Is Older transitive? Yes. (person1, person2) $\in$ Older and (person2, person3) $\in$ Older, than (person1, person3) $\in$ Older. \textbf{ALWAYS}.                                                                                         
