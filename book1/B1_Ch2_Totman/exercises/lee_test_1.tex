...
\includegraphics[width=42px,height=36px]{pics/A.png} &  A & \includegraphics[width=42px,height=36px]{pics/B.png} &  B \\
\includegraphics[width=42px,height=36px]{pics/C.png} & C & \includegraphics[width=42px,height=36px]{pics/D.png} & D \\
\includegraphics[width=42px,height=36px]{pics/E.png} &  E & \includegraphics[width=42px,height=36px]{pics/F.png} &  F \\
\includegraphics[width=42px,height=36px]{pics/G.png} & G & \includegraphics[width=42px,height=36px]{pics/H.png} &  H
