...
Determine $Flags^{-1}(SomeLetters)$
  ...
  \begin{selectAll}
  \choice{{\includegraphics[width=42px,height=36px]{pics/flags/A.png}}}
  \choice{{\includegraphics[width=40px,height=34px]{pics/flags/E.png}}}
  \choice{{\includegraphics[width=39px,height=32px]{pics/flags/i.png}}}
  \choice{{\includegraphics[width=39px,height=34px]{pics/flags/Kpng}}}
  \choice{{\includegraphics[width=39px,height=33px]{pics/flags/O.png}}}
  \choice{{\includegraphics[width=39px,height=34px]{pics/flags/U.png}}}
  \end{selectAll}
  \begin{feedback}
