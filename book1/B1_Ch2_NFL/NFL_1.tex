...
\begin{problem} \wordChoice{\choice[correct]{True} \choice{False}} (Kelly Holcomb, Cleveland Browns) $\in$ Q-CLE
\begin{feedback}
...
\begin{problem} \wordChoice{\choice{Yes} \choice[correct]{No}} (Dan Marino, Miami Dolphins) $\in$ Q-CLE
\begin{feedback}
...
\begin{problem} \wordChoice{\choice[correct]{Yes} \choice{No}} (Don Strock, Miami Dolphins) $\in$ Q-CLE
\begin{feedback}
...
\begin{problem} \wordChoice{\choice[correct]{Yes} \choice{No}} (Tom Flick, New York Jets) $\in$ Q-CLE
\begin{feedback}
