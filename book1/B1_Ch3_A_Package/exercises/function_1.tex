...
\begin{exercise}
Solve Shirt(familyMember) = {\includegraphics[width=33px,height=49px]{pics/elements/shirts/shirts4.png}}
  \begin{selectAll}
    \choice[correct]{{\includegraphics[width=33px,height=49px]{pics/elements/family/family1.png}}}
    \choice[correct]{{\includegraphics[width=33px,height=49px]{pics/elements/family/family2.png}}}
    \choice{{\includegraphics[width=33px,height=49px]{pics/elements/family/family3.png}}}
    \choice[correct]{{\includegraphics[width=33px,height=49px]{pics/elements/family/family4.png}}}
    \choice[correct]{{\includegraphics[width=33px,height=49px]{pics/elements/family/family5.png}}}
  \end{selectAll}
  \begin{feedback}
Three family members are partnered with {\includegraphics[width=33px,height=49px]{pics/elements/shirts/shirts4.png}}.
  \end{feedback}
\end{exercise}
